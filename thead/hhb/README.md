...
| --quantization-scheme | ['int4_asym_w_sym', 'uint8_asym', 'int8_asym', 'int8_sym', 'int8_asym_w_sym', 'int16_sym', 'float16', 'float32', 'unset'] | unset | Scheme of quantization. default is unset, and select scheme by --board. |
...
| --hybrid-quantization-scheme | ['int4_asym_w_sym', 'uint8_asym', 'int8_asym', 'int8_sym', 'int8_asym_w_sym', 'int16_sym', 'float16', 'unset'] | unset | Scheme of hybrid quantization. default is unset. |
