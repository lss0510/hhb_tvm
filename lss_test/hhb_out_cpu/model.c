...
void *csinn_(char *params_base) {
  ...
  params_0->base.api = CSINN_TH1520;
  ...
  csinn_power_init(output_0, rhs_2, output_2, params_2);
  ...
  params_5->base.api = CSINN_TH1520;
  csinn_reshape_init(output_4, output_5, params_5);
  ...
  params_6->base.api = CSINN_TH1520;
  ...
  csinn_power(output_0, rhs_2, output_2, params_2);
  csinn_conv2d(output_2, output_4, kernel_4, bias_4, params_4);
  csinn_reshape(output_4, output_5, params_5);
...
void *csinn_nbg(char *path) {
  ...
  struct csinn_tensor *input0_0 = csinn_alloc_tensor(sess);
  input0_0->dim[0] = 1;
  input0_0->dim[1] = 3;
  input0_0->dim[2] = 224;
  input0_0->dim[3] = 224;
  input0_0->dim_count = 4;
  input0_0->name = "input0_0";
  input0_0->qinfo->zero_point = -13;
  input0_0->qinfo->scale = 0.018333;
  input0_0->qinfo->min = -2.107878;
  input0_0->qinfo->max = 2.567000;
  input0_0->dtype = CSINN_DTYPE_INT8;
  input0_0->layout = CSINN_LAYOUT_NCHW;
  ...
  output_6->qinfo->zero_point = -13;
  output_6->qinfo->scale = 0.000297;
  output_6->qinfo->min = -0.033983;
  output_6->qinfo->max = 0.041633;
  output_6->dtype = CSINN_DTYPE_INT8;
  output_6->layout = CSINN_LAYOUT_NC;

  csinn_set_tensor_entry(output_6, sess);
  csinn_set_output(0, output_6, sess);
  csinn_set_tensor_entry(input0_0, sess);
  csinn_set_input(0, input0_0, sess);
  sess->model.bm_path = path;
